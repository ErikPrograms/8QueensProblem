...
namespace EightQueensProgram
{
    public class Backtracker
    {
        ...
        private int i;                                                 // x[j]
        private Grid<int> x = new Grid<int>(1, 8);                      // Queen position.
        private bool [,] a = new Grid [height,width](1, 8, true);      // true -- no queen in row.
        private bool [,] b = new Grid [height,width](2, 16, true);     // true -- no queen in /-diagonal.
        private bool [,] c = new Grid [height,width](-7, 7, true);     // true -- no queen in \-diagonal.
